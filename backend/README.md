...
## Project Structure
    ...
    ├── chngpersonaltrainin_34148  # Django project configurations
...
1. Clone this repo and `cd chngpersonaltrainin_34148`
...
2. Clone this repo and `cd chngpersonaltrainin_34148`
